Project Title: pandas-challenge
Module 4 (Pandas Challenge) files

Project Description: Project was to analyze Schools_complete.CSV and Students_complete.CSV for statistics and trends according to Module 4 assignment details.


How to Use the Project: Project would ideally be used for Python users to review statistics of school system reporting data.
